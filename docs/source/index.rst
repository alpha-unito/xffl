.. Cross-Facility Federated Learning documentation master file, created by
   sphinx-quickstart on Thu Oct  2 06:15:29 2025.
...
`Cross-Facility Federated Learning (xFFL) <https://hpc4ai.unito.it/hpc-federation>`_ is a federated learning (FL) framework based on the `StreamFlow workflow management system (WMS) <https://streamflow.di.unito.it>`_ developed in the `Parallel Computing Alpha research group <https://alpha.di.unito.it>`_ at the University of Turin, Italy.
