...
def save_model_checkpoint(
    ...
    if rank == 0:
        ...
        if cfg.enable_fsdp and cfg.use_fast_kernels:
            model_old.save_pretrained(save_dir, state_dict=cpu_state, safe_serialization=False)
        else:
            model.save_pretrained(save_dir, state_dict=cpu_state, safe_serialization=False)
